...
def intro(): 
    ...
    print_pause("A man in gray robes and a tall pointed hat is watching you curiously.")
...
def nowalk():
    response = valid_input("Choose what you will do next: "
                           ...
                           "left", "right")
    if "left" in response:
        print_pause("You stumble upon a crowd of Orcs and get devoured by them.")
    elif "right" in response:
        print_pause("You're being picked up by a troll and find you way into his stomach.")
...
def checkornot():
    response = valid_input("Choose what you will do next: "
                           ...
                           "yes", "no")
    if "yes" in response:
        print_pause("It's Gollum looking for his precious...")
        print_pause("He has been looking for so long that he's quite hungry...")
...
def yeswalk():
    response = valid_input("Choose what you will do next: "
                           ...
                           "yes", "no")
    if "yes" in response:
        print_pause("Thorin, son of Thrain, son of Thror gives you a reassuring smile.")
        print_pause("With this encouragement the dwarves, Bilbo, and you set out for Erebor")
        print_pause("You hear a weird whisper in the bushes...")
        checkornot()
    elif "no" in response:
        print_pause("Bilbo leaves his house under your supervision while he's gone.")
...
def get_response():
    response = valid_input("Choose what you will do next: "
                           ...
                           "yes", "no")
    if "yes" in response:
        print_pause("The walk doesn't take long and you're already in front Bilbo's house.")
        print_pause("There's a lot of sound coming out of the house")
        print_pause("Gandalf knocks the door...")
        print_pause("Bilbo Baggins, with an unamused expression, lets you in.")
        print_pause("Dwarves are all around you.")
        print_pause("You learn that the dwarves and Bilbo will set out on a journey.")
        yeswalk()
    elif "no" in response:
        print_pause("Gandalf shrugs: \"Then may the stars guide you\", he uses his wand and vanishes in smoke...")
